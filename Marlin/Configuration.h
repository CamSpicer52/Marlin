...
//Added 4/18 to supress warning messages (CJS)
...
#define STRING_CONFIG_H_AUTHOR "(CJS, 2.1.2)" // Who made the changes.
#define MARLIN_WEBSITE_URL "  08/16/2023_Rev3  " //(CJS)
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    //Standard 12/16/2021
    #define DEFAULT_Kp  43.06
    #define DEFAULT_Ki   3.32
    #define DEFAULT_Kd 139.54
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 353.72
  #define DEFAULT_bedKi 169.09
  #define DEFAULT_bedKd 1207.35
...
/**
 * Endstop "Hit" State
 * Set to the state (HIGH or LOW) that applies to each endstop. //(CJS)
 */
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5, 25 } //(CJS)

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 10, 50 } // ...or, set your own edit limits //(CJS)
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1100, 800, 50, 10000 } //(CJS)

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 100, 15000 } // ...or, set your own edit limits //(CJS)
#endif
 ...
 */
#define DEFAULT_ACCELERATION          650    // X, Y, Z and E acceleration for printing moves //(CJS)
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.06 // (mm) Distance from real junction edge //(CJS)
 ...
 */
#define S_CURVE_ACCELERATION //(CJS)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -8, 75.8, 0 } 
...
#define Z_CLEARANCE_MULTI_PROBE     6 // (mm) Z Clearance between multiple probes
#define Z_AFTER_PROBING           15 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping

// For M851 give a range for adjusting the Z probe offset
#define Z_PROBE_OFFSET_RANGE_MIN -5 // (mm)
...
#define Y_BED_SIZE 210 //(CJS)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -13 //(CJS)
#define Z_MIN_POS 0
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //(CJS)
...
#define AUTO_BED_LEVELING_BILINEAR //(CJS)
 ...
 */
#define LCD_BED_LEVELING //(CJS)

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points //(CJS)
#endif
