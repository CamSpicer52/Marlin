...
#define MARLIN_WEBSITE_URL "  2024-10-30_LGXExtruder  " //(CJS) src/language.h
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 3211.83, 413.35 } 
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 3.5, 76, 0 } 
...
#define XY_PROBE_FEEDRATE (2700)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (160)
...
#define Z_PROBE_ERROR_TOLERANCE     15 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
...
//
#define STARTUP_TUNE { 698, 300, 0, 50, 523, 50}
