 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.1, 80.1, 3192, 139.47 } //mk10 { 80.1, 80.1, 1598.8, 97.43746 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1100, 1100, 50, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -8, 75.8, -2.75 } //.1mm feeler gague
